...
- **A-16** [S1] 영어 대명사 직역 (그/그녀/그것/그들) — 영어 `he/she/it/they → 그/그녀/그것/그들`을 1대1…
  시그니처: "그/그녀/그것/그들" 단락 3회+ 영어 대명사 직역 · 예: :
...
- **C-8** [S1] 대칭 대구 공식 "A인가, B인가" 반복 — 동일 문서에서 이항 대립이 3회 이상 평행구로 반복. 영어 수사학…
  시그니처: "A인가, B인가"·"A가 아니라 B" 대구 3회+ 반복 · 예: "독점인가, 확산인가" / "전략가에게는 ~, 입…
...
- **E-7** [S2] 청자 경어법 일관성 손실 (해라/하게/하오/해요/합쇼체) — 한국어는 교착어로서 종결어미가 (a) 문장종결법, (b) 화행, (…
  시그니처: 대화-구어 한정 (블로그-카피 산문 제외). 그 안에서 청자 경어법 단계(…
...
- **J-2** 따옴표 과다 — 개념어·강조어에 "" 남발.
  시그니처: 따옴표 강조 5회+
- **J-3** [S1] 대시(—) 남용 — 영어 em-dash 스타일 부가 설명. 문장 중간에 줄표를 끼워 넣…
  시그니처: 한국어 산문 문단 안에 끼운 줄표(—) 3회 이상 (헤딩, 표, 코드, 목… · 예: "AI는 도구 — 그 이상도 이하도 아닌 — 이다
- **J-4** 괄호 부연 과다
  시그니처: "(이는 ~을 의미한다)" 같은 부연이 반복.
- **J-5** [S3] 가운뎃점(·) 나열 남용
  시그니처: 블로그·카피에서 한 문단 2회+ 반복될 때만. 개별 사용은 정상

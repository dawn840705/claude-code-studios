...
- v1.6 8 functions (comma_inclusion_rate ... lexical_diversity) are imported
  *as-is* from reference/metrics.py (signature + return preserved). DO NOT
...
`skills/humanize-korean/reference/`.
...
# metrics.py ships in the same reference/ directory as this file.

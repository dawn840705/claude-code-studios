...
- **E-7** 대화-구어 한정 (블로그-카피 산문 제외). 그 안에서 청자 경어법 단계(해라/하게/하오/해요/합쇼) 혼재 → 격식 등급 하나로 일관 유지
...
- **J-3** 한국어 산문 문단 안에 끼운 줄표(—) 3회 이상 (헤딩, 표, 코드, 목록 표지는 셈에서 빠짐) → 쉼표, 괄호, 별도 문장으로 분해. 원문에 이미 있던 대시는 보존

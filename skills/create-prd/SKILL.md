---
name: create-prd
description: "Guided, section-by-section PRD authoring for a single product feature. Gathers context from the product concept and existing PRDs, walks through each required section collaboratively, and writes to product/prd/prd-<feature>.md. Product-track counterpart of /design-system."
...
- **Stack pin**: `.claude/docs/technical-preferences.md` — platform, framework,

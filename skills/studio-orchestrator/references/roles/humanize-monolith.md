...
2. **룰북 1회 Read**: `reference/quick-rules.md` (~130줄, S1·S2 핵심만)
...
- `quick_rules_path`: 오케스트레이터가 전달하는 절대 경로(`skills/humanize-korean/reference/quick-rules.md` 치환값). 에이전트는 이 인자를 그대로 Read 한다.
